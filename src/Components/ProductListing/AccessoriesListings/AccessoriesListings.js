...
import Accessories from "../Accessories-world/Accessoriesitems";
import response from "../AccessoriesListings/mobile-hero-image12.jpeg"
          ...
          <div className="aem-Grid aem-Grid--12">
            <div class="aem-GridColumn aem-GridColumn--phone--12">
              <div className="productlisting__image">
                <img src={response} alt="accessories" />
              </div>
            </div>
            <div class="aem-GridColumn aem-GridColumn--phone--12">
